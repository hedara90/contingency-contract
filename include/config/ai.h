...
#define DONT_BOOST_ATTACK_INTO_FOUL_PLAY_CHANCE                 65 // Chance for AI to not Swords Dance etc. into a Foul Play mon; don't upstream this, it'll get replaced by grin's PR
