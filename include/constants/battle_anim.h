...
#define ANIM_TAG_ICE_WISP_ORB               (ANIM_SPRITES_START + 413)
#define ANIM_TAG_ICE_WISP_FLAKES            (ANIM_SPRITES_START + 414)
#define ANIM_TAG_COUNT                      GET_TRUE_SPRITE_INDEX(ANIM_TAG_ICE_WISP_FLAKES + 1)
