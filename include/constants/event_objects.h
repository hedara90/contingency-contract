...
enum
{
    ...
    OBJ_EVENT_GFX_CC_GUARD,
    OBJ_EVENT_GFX_NIAN_TAILLESS,
    OBJ_EVENT_GFX_TAIL_NIAN,
    NUM_OBJ_EVENT_GFX,
};
...
#define OBJ_EVENT_PAL_TAG_NPC_RECORDKEEPERS_1     0x1134
#define OBJ_EVENT_PAL_TAG_NPC_RECORDKEEPERS_2     0x1135
#define OBJ_EVENT_PAL_TAG_SATSUKI                 0x1136
#define OBJ_EVENT_PAL_TAG_OPERATOR_1              0x1137
#define OBJ_EVENT_PAL_TAG_OPERATOR_2              0x1138
#define OBJ_EVENT_PAL_TAG_OPERATOR_3              0x1139
#define OBJ_EVENT_PAL_TAG_CC_GIRL                 0x113A
...
#define MON_CROBAT SPECIES_CROBAT + (1 << 14)
#define MON_DRUDDIGON SPECIES_DRUDDIGON + (1 << 14)
#define MON_DUBWOOL SPECIES_DUBWOOL + (1 << 14)
#define MON_MEDICHAM SPECIES_MEDICHAM + (1 << 14)
#define MON_INCIN SPECIES_INCINEROAR + (1 << 14)
#define MON_TORTERRA SPECIES_TORTERRA + (1 << 14)
#define MON_TORKOAL SPECIES_TORKOAL + (1 << 14)
#define MON_DEDENNE SPECIES_DEDENNE + (1 << 14)
#define MON_TENTACRUEL SPECIES_TENTACRUEL + (1 << 14)
#define MON_DELPHOX SPECIES_DELPHOX + (1 << 14)
#define MON_WEAVILE SPECIES_WEAVILE + (1 << 14)
#define MON_FERROTHORN SPECIES_FERROTHORN + (1 << 14)
#define MON_NOIVERN SPECIES_NOIVERN + (1 << 14)
