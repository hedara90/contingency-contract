...
static const u16 sEvilTeam_Palette[] = INCGFX_U16("graphics/battle_transitions/cc_factions.pal", ".gbapal");
static const u32 sTeamAqua_Tileset[] = INCGFX_U32("graphics/battle_transitions/endfield.png", ".4bpp.smol");
static const u32 sTeamAqua_Tilemap[] = INCGFX_U32("graphics/battle_transitions/endfield.bin", ".smolTM");
static const u32 sTeamMagma_Tileset[] = INCGFX_U32("graphics/battle_transitions/rhodesisland.png", ".4bpp.smol");
static const u32 sTeamMagma_Tilemap[] = INCGFX_U32("graphics/battle_transitions/rhodesisland.bin", ".smolTM");
