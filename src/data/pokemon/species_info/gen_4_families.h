...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_RAMPARDOS] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_SHEER_FORCE, ABILITY_MOLD_BREAKER, ABILITY_MOLD_BREAKER },
        .ability1Threshold = 1,
        .ability2Threshold = 4,
        .bodyColor = BODY_COLOR_BLUE,
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_GARCHOMP] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_ROUGH_SKIN, ABILITY_NO_GUARD, ABILITY_NONE },
        .ability1Threshold = 3,
        .bodyColor = BODY_COLOR_BLUE,
...
#define ROTOM_FAMILY_TYPES { TYPE_ELECTRIC, TYPE_GHOST }
    ...
    [SPECIES_HEATRAN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_FLAME_BODY, ABILITY_FLASH_FIRE, ABILITY_DESOLATE_LAND },
        .ability1Threshold = 1,
        .ability2Threshold = 4,
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_MANAPHY] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_HYDRATION, ABILITY_STORM_DRAIN, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BLUE,
