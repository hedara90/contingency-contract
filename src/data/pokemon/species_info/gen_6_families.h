...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_DELPHOX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BLAZE, ABILITY_NONE, ABILITY_TELEPATHY },
        .bodyColor = BODY_COLOR_RED,
...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx, _overworldAnim)   \
    ...
    [SPECIES_MEOWSTIC_M] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PRANKSTER, ABILITY_FRIEND_GUARD, ABILITY_NONE },
        .ability1Threshold = 4,
        .bodyColor = BODY_COLOR_BLUE,
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_DRAGALGE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_ADAPTABILITY, ABILITY_MIMICRY, ABILITY_HOSPITALITY },
        .ability1Threshold = 1,
        .bodyColor = BODY_COLOR_BROWN,
