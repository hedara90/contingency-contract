...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_DECIDUEYE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_OVERGROW, ABILITY_ARENA_TRAP, ABILITY_LONG_REACH },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_ARAQUANID] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_BUG),
        .abilities = { ABILITY_WATER_ABSORB, ABILITY_RAIN_DISH, ABILITY_WATER_BUBBLE },
        .ability1Threshold = 2,
        .ability2Threshold = 4,
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_COMFEY] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_FRIEND_GUARD, ABILITY_TRIAGE, ABILITY_NONE },
        .ability1Threshold = 4,
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
    ...
    [SPECIES_PALOSSAND] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_WATER_COMPACTION, ABILITY_NEUROFORCE, ABILITY_ARENA_TRAP },
        .ability1Threshold = 3,
        .bodyColor = BODY_COLOR_BROWN,
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal, heldItem)\
    ...
    [SPECIES_DRAMPA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_BERSERK, ABILITY_SAP_SIPPER, ABILITY_STORMCALLER },
        .bodyColor = BODY_COLOR_WHITE,
