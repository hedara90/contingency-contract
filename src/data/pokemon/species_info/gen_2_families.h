...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_WEAVILE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SUPER_LUCK, ABILITY_ADAPTABILITY, ABILITY_MAGICIAN },
        .ability1Threshold = 4,
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_MAMOSWINE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_OWN_TEMPO, ABILITY_THICK_FAT, ABILITY_CUD_CHEW },
        .ability1Threshold = 2,
        .ability2Threshold = 4,
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_OCTILLERY] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_WATER_2),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SUCTION_CUPS, ABILITY_SNIPER, ABILITY_NONE },
    #else
