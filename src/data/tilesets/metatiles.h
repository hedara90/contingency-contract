...
const u16 gMetatiles_PorytilesManaged_concenter[] = INCBIN_U16("data/tilesets/primary/concenter/porytiles_bin/metatiles.bin");
const u16 gMetatileAttributes_PorytilesManaged_concenter[] = INCBIN_U16("data/tilesets/primary/concenter/porytiles_bin/metatile_attributes.bin");
