...
static const u8 sRiskValues[] =
{
    ...
    [RISK_HAS_WONDER_GUARD] = 6,
    [RISK_HAS_REGENERATOR] = 1,
    [RISK_HAS_BATTLE_ARMOR] = 1,
    [RISK_OPPONENT_MOVES_FIRST] = 3,
    [RISK_OPPONENT_MORE_MONS_1] = 3,
    [RISK_OPPONENT_MORE_MONS_2] = 4,
    [RISK_TURN_LIMIT_1] = 1,
    [RISK_TURN_LIMIT_2] = 2,
    [RISK_TURN_LIMIT_3] = 3,
    ...
    [RISK_PLAYER_HAS_RECOIL] = 2,
    [RISK_OPPONENT_INFLICTS_GASTRO_ACID] = 1,
    [RISK_OPPONENT_ATTACKS_SWITCHES] = 2,
    ...
    [RISK_HAS_GUARANTEED_ACCURACY] = 2,
    [RISK_HAS_GEN_1_CRIT_CHANCE] = 2,
    ...
    [RISK_OPPONENT_HAS_ITEMS] = 5,
    [RISK_PARTY_MINUS_1] = 3,
    [RISK_PARTY_MINUS_2] = 4,
    [RISK_PARTY_MINUS_3] = 5,
    [RISK_MINUS_1_MOVE] = 1,
